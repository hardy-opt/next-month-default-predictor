...
2. **Download Data:**  
   * Obtain the default\_of\_credit\_card\_clients.csv dataset. (You'll need to specify where the user can get this, e.g., UCI Machine Learning Repository or direct link if permissible).  
...
```
   ...
   *(Create a requirements.txt file by running pip freeze \> requirements.txt after installing all dependencies.)*  
5. **Run the Pipeline:**  
```console
python main.py
```
...
<p align="center">
  <img src="results/figures/LR.png" alt="Logistic Regression" width="30%">
  <img src="results/figures/RF.png" alt="Random Forest" width="30%">
  <img src="results/figures/XGB.png" alt="Extreme Gradient Boosting" width="30%">
</p>
